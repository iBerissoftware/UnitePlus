...
$(document).ready(function() {
	...
	function ccf_apply_copyright() {
		$('.creativecontactform_wrapper').each(function() {
			var ccf_copy_html = '<div class="powered_by powered_by_1 ccf_bc_hidden">Powered By <a rel="nofollow" href="http://creative-solutions.net/joomla/creative-contact-form" target="_blank">Creative Contact Form</a></div>';
			$(this).find('.ccf_copyright_wrapper').html(ccf_copy_html);
