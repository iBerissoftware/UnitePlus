			 				...
			 				if(sizeof($field_data) > 0) {
		 						...
		 						foreach($fields_final_array as $k => $field_columns_array) {
		 							...
		 							if(isset($field_columns_array['1']) || isset($field_columns_array['2'])) {
			 							echo '<div class="'.$field_box_animation_class.' creative_field_box_wrapper_1 creative_field_box_animation_state_1"><div class="creative_field_box_wrapper_1_inner">';
			 						...
			 						if(isset($field_columns_array['2'])) {
			 							//print right column
			 							echo '<div class="'.$field_box_animation_class.' creative_field_box_wrapper_2 creative_field_box_animation_state_1"><div class="creative_field_box_wrapper_2_inner">';
			 								if(isset($field_columns_array['2'])) {
		 							...
		 							if(isset($field_columns_array['0'])) {
			 							//print right column
			 							echo '<div class="creativecontactform_clear"></div><div class="'.$field_box_animation_class.'  creative_field_box_wrapper_0 creative_field_box_animation_state_1">';
			 								if(isset($field_columns_array['0'])) {
